...
```{r}
random <- 200   #choose the number of assets you want to take only if you don't want to run the computations for all the assets
set.seed(1312)
...
```{r}
#1. EQUAL WEIGHT
demiguelR <- as.matrix(read.table('../TFG/Resultats/200/200DeMiguel R.csv', header=TRUE, sep=' '))
demiguelW <- as.matrix(read.table('../TFG/Resultats/200/200DeMiguel W.csv', header=TRUE, sep=' '))

#2. SAMPLE COVARIANCE
sampleR <- as.matrix(read.table('../TFG/Resultats/200/200Sample_cov R.csv', header=TRUE, sep=' '))
sampleW <- as.matrix(read.table('../TFG/Resultats/200/200Sample_cov W.csv', header=TRUE, sep=' '))

#3. LINEAR SHRINKAGE to IDENTITY MATRIX
wolfR <- as.matrix(read.table('../TFG/Resultats/200/200LR sam_cov R.csv', header=TRUE, sep=' '))
wolfW <- as.matrix(read.table('../TFG/Resultats/200/200LR sam_cov W.csv', header=TRUE, sep=' '))

#4. NON-LINEAR SHRINKAGE to IDENTITY MATRIX
sampleNlR <- as.matrix(read.table('../TFG/Resultats/200/200NL sam_cov R.csv', header=TRUE, sep=' '))
sampleNlW <- as.matrix(read.table('../TFG/Resultats/200/200NL sam_cov W.csv', header=TRUE, sep=' '))

#6. MARKET FACTOR with LINEAR SHRINKAGE IN RESIDUALS
marketR <- as.matrix(read.table('../TFG/Resultats/200/200Market LR residuals R.csv', header=TRUE, sep=' '))
marketW <- as.matrix(read.table('../TFG/Resultats/200/200Market LR residuals W.csv', header=TRUE, sep=' '))

#7. FAMA FRENCH 3 FACTORS with LINEAR SHRINKAGE IN RESIDUALS
fama3R <- as.matrix(read.table('../TFG/Resultats/200/200Fama3 LR residuals R.csv', header=TRUE, sep=' '))
fama3W <- as.matrix(read.table('../TFG/Resultats/200/200Fama3 LR residuals W.csv', header=TRUE, sep=' '))

#8.  FAMA FRENCH 5 FACTORS with LINEAR SHRINKAGE IN RESIDUALS
fama5R <- as.matrix(read.table('../TFG/Resultats/200/200Fama5 LR residuals R.csv', header=TRUE, sep=' '))
fama5W <- as.matrix(read.table('../TFG/Resultats/200/200Fama5 LR residuals W.csv', header=TRUE, sep=' '))

#9. LINEAR SHRINKAGE to CONSTANT CORRELATION (LEDOIT and WOLF)
con_wolfR <- as.matrix(read.table('../TFG/Resultats/200/200Con_corr LW R.csv', header=TRUE, sep=' '))
con_wolfW <- as.matrix(read.table('../TFG/Resultats/200/200Con_corr LW W.csv', header=TRUE, sep=' '))

#11. PCA with 1 PCs
pca1R <- as.matrix(read.table('../TFG/Resultats/200/200PCA1 LR residuals R.csv', header=TRUE, sep=' '))
pca1W <- as.matrix(read.table('../TFG/Resultats/200/200PCA1 LR residuals W.csv', header=TRUE, sep=' '))

#12. PCA with 3 PCs
pca3R <- as.matrix(read.table('../TFG/Resultats/200/200PCA3 LR residuals R.csv', header=TRUE, sep=' '))
pca3W <- as.matrix(read.table('../TFG/Resultats/200/200PCA3 LR residuals W.csv', header=TRUE, sep=' '))

#13. PCA with 5 PCs
pca5R <- as.matrix(read.table('../TFG/Resultats/200/200PCA5 LR residuals R.csv', header=TRUE, sep=' '))
pca5W <- as.matrix(read.table('../TFG/Resultats/200/200PCA5 LR residuals W.csv', header=TRUE, sep=' '))
```
...
write.table(demiguelW,'../TFG/Resultats/200/200DeMiguel W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(demiguelR,'../TFG/Resultats/200/200DeMiguel R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
write.table(sampleW,'../TFG/Resultats/200/200Sample_cov W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(sampleR,'../TFG/Resultats/200/200Sample_cov R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
write.table(wolfW,'../TFG/Resultats/200/200LR sam_cov W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(wolfR,'../TFG/Resultats/200/200LR sam_cov R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
write.table(sampleNlW,'../TFG/Resultats/200/200200NL sam_cov W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(sampleNlR,'../TFG/Resultats/200/200200NL sam_cov R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
write.table(marketW,'../TFG/Resultats/200/200Market LR residuals W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(marketR,'../TFG/Resultats/200/200Market LR residuals R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
write.table(fama3W,'../TFG/Resultats/200/200Fama3 LR residuals W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(fama3R,'../TFG/Resultats/200/200Fama3 LR residuals R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
write.table(fama5W,'../TFG/Resultats/200/200Fama5 LR residuals W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(fama5R,'../TFG/Resultats/200/200Fama5 LR residuals R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
write.table(con_wolfW,'../TFG/Resultats/200/200Con_corr LW W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(con_wolfR,'../TFG/Resultats/200/200Con_corr LW R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
colnames(pca1R)<-"1PC + LS"

write.table(pca1W,'../TFG/Resultats/200/200PCA1 LR residuals W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(pca1R,'../TFG/Resultats/200/200PCA1 LR residuals R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
colnames(pca3R)<-"3PCs + LS"

write.table(pca3W,'../TFG/Resultats/200/200PCA3 LR residuals W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(pca3R,'../TFG/Resultats/200/200PCA3 LR residuals R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
...
colnames(pca5R)<-"5PCs + LS"

write.table(pca5W,'../TFG/Resultats/200/200PCA5 LR residuals W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(pca5R,'../TFG/Resultats/200/200PCA5 LR residuals R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
