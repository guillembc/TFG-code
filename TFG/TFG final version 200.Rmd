...
write.table(sampleNlW,'../TFG/Resultats/200/200NL sam_cov W.csv', sep=' ', row.names=TRUE, col.names=TRUE)
write.table(sampleNlR,'../TFG/Resultats/200/200NL sam_cov R.csv', sep=' ', row.names=TRUE, col.names=TRUE)
```
